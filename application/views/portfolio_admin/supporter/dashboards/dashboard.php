<div class="page-container">
    <div class="page-header clearfix">
        <div class="text-center">
            <h3 class="mt-0 mb-5" style="text-transform: capitalize; border: 1px solid #e6e6e6; border-radius: 25px; padding: 15px"><?php echo "Welcome to " . $_SESSION['logged_in']['name'] ?></h3>
        </div>
        <!--
                            ...
                            <div class="p-30 overlay bg-black"><img src="../build/images/backgrounds/06.jpg" alt="" class="img-main img-responsive">
                                <div class="clearfix">
                                    <div class="pull-left"><i class="fs-60 wi wi-day-cloudy-gusts"></i>
                                        <h3 class="fs-22">Mostly Cloudy</h3>
