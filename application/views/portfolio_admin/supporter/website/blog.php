    ...
    <div class="section-container">
        ...
        <div class="row blogs-masonry">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-1.jpg') ?>" alt="#">
                    </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-2.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-3.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-4.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-5.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
                        <span class="cat">Web Design</span>
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-6.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-7.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-8.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
                        <span class="cat">Technology</span>
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="<?php echo site_url('welcome/blog_dark') ?>" class="blog-item">
                    <div class="blog-image">
                        <img src="<?php echo base_url('public/img/blog/img-9.jpg') ?>" alt="#">
                    </div>
                    <div class="blog-content">
                        <span class="cat">Traveling</span>
